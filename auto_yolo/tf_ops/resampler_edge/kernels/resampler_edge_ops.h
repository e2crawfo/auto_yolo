...
// Helper functor for the ResamplerEdge Op in 2D
template <typename Device, typename T>
struct ResamplerEdge2DFunctor {
...
// Helper functor for the ResamplerEdge Gradient Op in 2D
template <typename Device, typename T>
struct ResamplerEdgeGrad2DFunctor {
  void operator()(::tensorflow::OpKernelContext* ctx, const Device& d,
                  const T* __restrict__ data, const T* __restrict__ warp,
