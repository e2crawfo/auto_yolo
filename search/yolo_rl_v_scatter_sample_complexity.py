...
distributions = dict(n_train=[25e3, 40e3, 55e3, 70e3, 85e3, 100e3])
...
config.log_name = "{}_VS_{}_env={}_sample_complexity".format(alg_config.log_name, env_config.log_name, args.env)
...
if kind == "long_cedar":
    kind_args = dict(
        max_hosts=2, ppn=15, cpp=1, gpu_set="0,1,2,3", wall_time="12hours",
    ...
    kind_args = dict(
        ...
        project="def-jpineau", cleanup_time="5mins", slack_time="5mins", n_repeats=5, n_param_settings=3)
...
clify.wrap_function(build_and_submit)(
    name="{}_param_search_{}_sample_complexity".format(args.env, kind), config=config,
